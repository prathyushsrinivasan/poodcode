...
export function Welcome({ onClose }: { onClose: () => void }) {
  ...
  const items: { icon: string; title: string; body: string }[] = [
    { icon: "📚", title: "DSA Curriculum", body: "271 problems taught in order — 33 units from printing a line to tries and Dijkstra, each with the why, the code shape and the signals that name it." },
