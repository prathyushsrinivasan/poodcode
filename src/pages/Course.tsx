...
// A course week's completion is tracked in the same localStorage set as Learn
// chapter-done, under a namespaced key so it never collides with a concept key.
...
export default function Course() {
  ...
  function setWeekDone(n: number, value: boolean) {
    setDone(new Set(setChapterDone(weekKey(n), value)));
  }
