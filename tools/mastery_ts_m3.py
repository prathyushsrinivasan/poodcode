...
TS_WEEKS.extend([
    ...
    _w(10, "Month 3 · The type system",
        ...
        ["ts_unions", "ts_aliases", "ts_literal_inference", "ts_enums"],
    ...
    _w(11, "Month 3 · The type system",
        ...
        ["ts_narrowing", "ts_type_predicates", "ts_nullish", "ts_control_flow"],
    ...
    _w(12, "Month 3 · The type system",
        ...
        ["ts_discriminated_unions", "ts_top_bottom"],
